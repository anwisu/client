...
const CategoryList = ({
    ...
    return (
        ...
        <View style={styles.categoryActionContainer}>
            ...
            onPress={onPressEdit}
            >
            <MaterialIcons name={"edit"} size={15} color={"rgb(45,45,45)"} />
            </TouchableOpacity>
            <TouchableOpacity
            style={[styles.actionButton, { backgroundColor: "#F4B546" }]}
            onPress={onPressDelete}
            >
            <MaterialIcons name={"delete"} size={15} color="rgb(45,45,45)" />
            </TouchableOpacity>
        </View>
        </View>
    );
